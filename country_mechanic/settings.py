"""
Django settings for country_mechanic project.
...
SECRET_KEY = 'qe%onkenc4f*1**442qsj^71z236jd92vkn+_1i)ktmhzig!2w'
...
ROOT_URLCONF = 'country_mechanic.urls'
...
WSGI_APPLICATION = 'country_mechanic.wsgi.application'
